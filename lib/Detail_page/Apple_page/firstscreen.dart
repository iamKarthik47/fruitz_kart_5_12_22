                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            'A Apple is a type of fruit. '
                                'The Apple tree is native to South Asia, '
                              ...
                              ButtonTheme(
                                ...
                                child: Center(
                                  child: ElevatedButton(
                                    // elevation: 0.0,
                                    // color: Colors.amber[300],
                                    style: ButtonStyle(elevation: MaterialStateProperty.all(20),backgroundColor: MaterialStateProperty.all(Colors.red.shade200),maximumSize: MaterialStateProperty.all(Size.infinite)),
                                    onPressed: () {},
                                    child: Text(
                                      'Add to cart',
                                      style:
