...
class FirstScreen2 extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _FirstScreen2();
  }
}

class _FirstScreen2 extends State<FirstScreen2> {
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            'A Banana is a type of fruit. '
                                'The Banana tree is native to South Asia, '
                            ...
                            children: <Widget>[
                              ...
                              ButtonTheme(
                                ...
                                child: ElevatedButton(
                                  // elevation: 0.0,
                                  // color: Colors.amber[300],
                                  style: ButtonStyle(elevation: MaterialStateProperty.all(20),backgroundColor: MaterialStateProperty.all(Colors.yellow.shade200)),
                                  onPressed: () {},
                                  child: Text(
                                    'Add to cart',
                                    style:
