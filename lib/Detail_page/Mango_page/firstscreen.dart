...
class FirstScreen8 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _FirstScreen8();
  }
}

class _FirstScreen8 extends State<FirstScreen8> {
                            ...
                            children: <Widget>[
                              ...
                              ButtonTheme(
                                ...
                                child: ElevatedButton(
                                  // elevation: 0.0,
                                  // color: Colors.amber[300],
                                  style: ButtonStyle(elevation: MaterialStateProperty.all(20),backgroundColor: MaterialStateProperty.all(Colors.amber.shade200)),
                                  onPressed: () {},
                                  child: Text(
                                    'Add to cart',
                                    style:
