...
class FirstScreen9 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _FirstScreen9();
  }
}

class _FirstScreen9 extends State<FirstScreen9> {
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            'A Pear is a type of fruit. '
                                'The pear tree is native to South Asia, '
                            ...
                            children: <Widget>[
                              ...
                              ButtonTheme(
                                ...
                                child: ElevatedButton(
                                  // elevation: 0.0,
                                  // color: Colors.amber[300],
                                  style: ButtonStyle(elevation: MaterialStateProperty.all(20),backgroundColor: MaterialStateProperty.all(Colors.green.shade200)),
                                  onPressed: () {},
                                  child: Text(
                                    'Add to cart',
                                    style:
