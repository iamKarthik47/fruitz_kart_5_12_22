...
class FirstScreen7 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _FirstScreen7();
  }
}

class _FirstScreen7 extends State<FirstScreen7> {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            'A Cherry is a type of fruit. '
                                'The cherry tree is native to South Asia, '
                            ...
                            children: <Widget>[
                              ...
                              ButtonTheme(
                                ...
                                child: ElevatedButton(
                                  // elevation: 0.0,
                                  // color: Colors.amber[300],
                                  style: ButtonStyle(elevation: MaterialStateProperty.all(20),backgroundColor: MaterialStateProperty.all(Colors.redAccent.shade200)),
                                  onPressed: () {},
                                  child: Text(
                                    'Add to cart',
                                    style:
