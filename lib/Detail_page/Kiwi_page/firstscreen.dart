...
class FirstScreen4 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _FirstScreen4();
  }
}

class _FirstScreen4 extends State<FirstScreen4> {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            'A kiwi is a type of fruit. '
                                'The kiwi tree is native to South Asia, '
                            ...
                            children: <Widget>[
                              ...
                              ButtonTheme(
                                ...
                                child: ElevatedButton(
                                  // elevation: 0.0,
                                  // color: Colors.amber[300],
                                  style: ButtonStyle(elevation: MaterialStateProperty.all(20),backgroundColor: MaterialStateProperty.all(Colors.greenAccent.shade200)),
                                  onPressed: () {},
                                  child: Text(
                                    'Add to cart',
                                    style:
