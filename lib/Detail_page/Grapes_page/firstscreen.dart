...
class FirstScreen3 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _FirstScreen3();
  }
}

class _FirstScreen3 extends State<FirstScreen3> {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            'A Grape is a type of fruit. '
                                'The Grapes tree is native to South Asia, '
                            ...
                            children: <Widget>[
                              ...
                              ButtonTheme(
                                ...
                                child: ElevatedButton(
                                  // elevation: 0.0,
                                  // color: Colors.amber[300],
                                  style: ButtonStyle(elevation: MaterialStateProperty.all(20),backgroundColor: MaterialStateProperty.all(Colors.purple.shade200)),
                                  onPressed: () {},
                                  child: Text(
                                    'Add to cart',
                                    style:
