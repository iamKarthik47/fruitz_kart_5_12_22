...
class FirstScreen10 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _FirstScreen10();
  }
}

class _FirstScreen10 extends State<FirstScreen10> {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            'A strawberry is a type of fruit. '
                                'The strawberry tree is native to South Asia, '
                            ...
                            children: <Widget>[
                              ...
                              ButtonTheme(
                                ...
                                child: ElevatedButton(
                                  // elevation: 0.0,
                                  // color: Colors.amber[300],
                                  style: ButtonStyle(elevation: MaterialStateProperty.all(20),backgroundColor: MaterialStateProperty.all(Colors.pinkAccent.shade200)),
                                  onPressed: () {},
                                  child: Text(
                                    'Add to cart',
                                    style:
